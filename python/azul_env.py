...
from bots import get_legal_moves, greedy_agent
from assets import COLORS, FLOOR_PENALTIES
...
class AzulEnv(gym.Env):
    def __init__(self):
        super().__init__()
        self.num_players = 4
        self.current_learning_player = 0
    ...
    def step(self, action_index):
        ...
        while any(f for f in self.game.factories) or self.game.center:
            ...
            if player_index == self.current_learning_player:
                ...
                if move not in get_legal_moves(self.game, player):
